...
from srunner.scenariomanager.scenarioatomics.atomic_criteria import (
    CollisionTest, InRouteTest, RouteCompletionTest, OutsideRouteLanesTest,
    RunningRedLightTest, RunningStopTest, ActorSpeedAboveThresholdTest)
...
class RouteScenario(BasicScenario):
    ...
    def _create_test_criteria(self):
        ...
        completion_criterion = RouteCompletionTest(self.ego_vehicles[0],
                                                   route=route)
